...
{
    public class LabelVisualElement : CustomUIElement
    {
        public override string ElementContainerClassName => "labelContainer";
        ...
        public LabelVisualElement(HEU_ParameterData parmData, int folderID, VisualElement parentContainer, HEU_HoudiniAsset houdiniAsset)
        {
        ...
        public override void SetUpElementField()
        {
            ...
            labelField.AddToClassList(ValueFieldClassName);
            labelField.text = parmData._stringValues[0];
