...
{
    public class GeometryInputVisualElement : CustomUIElement
    {
        ...
        public GeometryInputVisualElement(HEU_ParameterData parmData, int folderID, VisualElement parentContainer, HEU_HoudiniAsset houdiniAsset)
        {
        ...
        public override void SetUpElementField()
        {
            ...
            inputField.objectType = typeof(UnityEngine.GameObject);
        ...
        public override void SetChangeEvent()
        {
            ...
            {
                GameObject inputGeo = (GameObject)inputField.value;
                string paramName = parmData._name.ToString();

                parmData._paramInputNode.PendingInputObjectType = HEU_InputNode.InputObjectType.UNITY_MESH;
                parmData._paramInputNode.RemoveAllInputEntries();

                HEU_ParameterUtility.SetInputNode(houdiniAsset, paramName, inputGeo, 0);
